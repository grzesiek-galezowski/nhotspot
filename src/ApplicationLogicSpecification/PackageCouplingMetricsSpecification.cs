  ...
  public class PackageCouplingMetricsSpecification
  {
    ...
    public void ShouldCalculatePercentagesAcrossCommits()
    {
      var analysisResult = new RepoAnalysisDriver().Analyze(flow =>
      {
        ...
        flow.Commit(commit =>
        {
          commit.Dir("A1\\A2\\A3\\").File("A.cs").Modified();
          commit.Dir("A1\\A2\\A21\\A3").File("B.cs").Modified();
      ...
      entries.ElementAt(0).CouplingCount.Should().Be(1);
      entries.ElementAt(0).Left.Should().Be(RelativeDirectoryPath.Value("ROOT\\A1\\A2\\A21\\A3"));
      entries.ElementAt(0).Right.Should().Be(RelativeDirectoryPath.Value("ROOT\\C1"));
      ...
      entries.ElementAt(1).Left.Should().Be(RelativeDirectoryPath.Value("ROOT\\A1\\A2\\A21\\A3"));
      entries.ElementAt(1).Right.Should().Be(RelativeDirectoryPath.Value("ROOT\\B1"));
      ...
      entries.ElementAt(2).Left.Should().Be(RelativeDirectoryPath.Value("ROOT\\A1\\A2\\A3"));
      entries.ElementAt(2).Right.Should().Be(RelativeDirectoryPath.Value("ROOT\\B1"));
      ...
      entries.ElementAt(3).Left.Should().Be(RelativeDirectoryPath.Value("ROOT\\A1\\A2\\A3"));
      entries.ElementAt(3).Right.Should().Be(RelativeDirectoryPath.Value("ROOT\\A1\\A2\\A21\\A3"));
